<div class="relative mt-3 md:mt-0" x-data="{ isOpen : true }" @click.away="isOpen = false">
    ...
    type="text" 
    class="bg-gray-800 text-sm rounded-full w-64 px-4 focus:outline-none focus:shadow-outline pl-8 py-1" 
            ...
            @foreach ($searchResults as $result)
                <li class="border-b border-gray-700">
                     <a
                        ...
                        class="block hover:bg-gray-700 px-3 py-3 flex items-center transition
