...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{'https://image.tmdb.org/t/p/w500/'.$movieDetails->poster_path}}" alt="parasite" class="w-64 lg:w-96">
            <div class="md:ml-24">
                        ...
                        <div class="bg-gray-900 rounded">
                            ...
                            <div class="modal-body px-8 py-8">
                                <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                    <iframe class="responsive-iframe absolute top-0 
            ...
            <div class="container mx-auto px-4 py-16">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    @foreach ($movieDetails->credits->cast as $cast)
                        ...
                        <div class="mt-8">
                            <a 
                             {{-- image='{{'https://image.tmdb.org/t/p/w400/'.$cast->profile_path}}'"  --}}
                            href="{{route('actors.show',$cast->id)}}">
                                <img src="{{'https://image.tmdb.org/t/p/w300/'.$cast->profile_path}}" 
                                alt="actor" class="hover:opacity-75 transition
